...
[Foundations](https://nexus-resonance-codex.github.io/NRC/) • [Interactive Engine (HF)](https://huggingface.co/spaces/jtrag/NRC-Phi-Infinity-Engine) • [NRC Playground](#-nrc-playground) • [Primitives](src/nrc_math/primitives.py) • [Lattice Research](notebooks/) • [Proofs](proofs/)
