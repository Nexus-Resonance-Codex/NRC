...
Three-tab interactive app demonstrating the full Nexus Resonance Codex (NRC) (NRC)
...
with gr.Blocks(title="NRC Interactive — Nexus Resonance Codex (NRC) (NRC)", theme=THEME) as demo:
    gr.Markdown("""
# 🌀 Nexus Resonance Codex (NRC) (NRC) — Interactive Explorer
